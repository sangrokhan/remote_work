...
│   ├── parsers/          # 문서 유형별 파서 — docx_parser.py (DocxParser: heading/table/image 추출), docx_config.py (DocxParseConfig), extractor/ (PDF 추출 패키지: pipeline/text/tables/images/font_profile/debug/shared) (Task 1.1 ✅ DOCX, ✅ PDF)
