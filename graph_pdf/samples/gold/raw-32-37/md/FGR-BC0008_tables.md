...
| dscp-bypass-mcg | This leaf indicates dscp-bypass function for DL packets on MCG leg.<br>0: off<br>1: It inserts outer IP DSCP value to DL packets.<br>2: It inserts inner IP DSCP value to DL packets |
| dscp-bypass-scg | This leaf indicates dscp-bypass function for DL packets on SCG leg.<br>0: off<br>1: It inserts outer IP DSCP value to DL packets.<br>2: It inserts inner IP DSCP value to DL packets |
