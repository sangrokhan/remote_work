...
│   └── superpowers/
│       ├── specs/           # 기능 설계 문서 (brainstorming 산출물)
│       └── plans/           # 구현 계획 문서 (writing-plans 산출물)
├── src/
│   └── spar/                # 단일 최상위 패키지
│       ├── __init__.py
...
│                            #    ingest_excel, slice_3gpp_intros, gen_goldset_qa,
