...
Ported from ``token_traffic/core/streaming.py`` (DESIGN.md 5, A2 /
MIGRATION.md Phase 2), unchanged in behaviour. Generic SSE timing, not
public_ai-specific, so it lives in ``aipt/core`` next to ``wire.py``.
