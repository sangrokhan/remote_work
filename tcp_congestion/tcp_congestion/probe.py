"""probe: idle-period HTTP PING for RTT measurement only.

Sends a GET /ping on an already-open keep-alive socket and measures the
wall-clock round trip.  delivery_rate is intentionally NOT included in
the sample — it would be corrupted by the tiny probe payload (~100 B),
