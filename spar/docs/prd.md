...
> 🔧 **구현 중** (2026-05-01) — Dense 임베더 wrapper + encoder 싱글톤 진행. BM25 미착수.
...
- [ ] encoder 싱글톤/팩토리 — 진행 중 (`src/spar/encoder/` untracked, 계획 `docs/superpowers/plans/2026-05-01-encoder-singleton.md`)
- [ ] 임베딩 모델 후보:
  - `BAAI/bge-large-en-v1.5` (검증된 영어 모델)
  - `intfloat/e5-large-v2`
  - `nomic-embed-text-v1.5`
  - 도메인 적응 fine-tuning은 Phase 4 이후 검토
- [ ] Hybrid 결합: RRF (Reciprocal Rank Fusion) 또는 weighted sum — 계획 `docs/superpowers/plans/2026-05-01-bm25-hybrid-search.md`
